...
import CharityImage from "C:/Users/337673/Desktop/code/project-divert-frontend/public/charity.jpg";
import ConstructionImage from "C:/Users/337673/Desktop/code/project-divert-frontend/public/construction.jpg";
...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <p
        className="absolute -top-96 left-0 w-full h-full flex justify-center 
            items-center font-bold text-white text-5xl"
      >
        Choose which option best suits you
      </p>

      <button
        className=" rounded-lg bg-[#0473ba] p-2 text-white font-bold
